...
class ProfileScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    Provider.of<ProfileProvider>(context, listen: false).loadAppVersion();
    return Scaffold(
                  ...
                  child: Column(
                    children: [
                      ...
                      MenuButtonWidget(icon: Icons.logout, title: getTranslated('logOut', context), onTap: () {
                        showModalBottomSheet(backgroundColor: Colors.transparent, context: context, builder: (ctx)=> CustomAlertDialogWidget(
                          icon: Icons.question_mark_outlined,
                          title: getTranslated('are_you_sure_you_want_to_logout', context),
                          onPressLeft: ()=> Navigator.pop(context),
                          onPressRight: (){
                      ...
                      Padding(
                        ...
                        child: Consumer<ProfileProvider>(
                          builder: (context, appInfoProvider, child) {
                            final version = appInfoProvider.appVersion;
